...
(117, '6a23ab20-d1c5-4665-b1b9-ea8758060790', 'Another document', 'This is another document desc', '<p><span style=\"font-size: 18pt;\">Why will you delete me, please save me someone!</span></p>', '2024-02-23 10:23:41', 0),
(118, '6a23ab20-d1c5-4665-b1b9-ea8758060790', 'Another document', 'Another document desc', '', '2024-02-23 14:43:01', 0),
(119, 'ac19f9b6-8041-44bd-ac2d-8a87f371b4a2', 'test-title', 'test-description', 'test-content', '2024-02-23 16:44:51', 0);
...
(23, '92f31e82-f0fb-44ed-8e7f-c40922ee45e7', 'nasse', 'nasse@mail.com', '2024-02-23 16:40:57', '$2b$12$RT5w9PeBLsZ.IMP9fuJJc.Nw2iFhgeqVHHx9EupLK2.wwQ1v4ytbe');
...
--
ALTER TABLE `documents`
  MODIFY `document_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=120;
